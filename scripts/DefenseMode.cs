...
//initializing functions
	...
	public void CallVariousNodes(){
		...
		playerNode = GetNode<Player>("PlayerNodes/Player");
		
		towerLightNode = GetNode<TowerLight>("PlayerNodes/TowerLight");

		mainCamera = GetNode<Camera>("MainCamera");

		enemyControllerNode = GetNode<EnemyController>("Level/EnemySpawn");
